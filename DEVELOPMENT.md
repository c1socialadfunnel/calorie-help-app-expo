...
```bash
git remote add encore encore://calorie-help-app-ocgi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/calorie-help-app-ocgi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/calorie-help-app-ocgi/settings/integrations/github)

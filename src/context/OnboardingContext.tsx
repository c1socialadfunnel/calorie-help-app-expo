...
export function OnboardingProvider({ children }: { children: React.ReactNode }) {
  ...
  const calculateCalorieTarget = (): number => {
    const { gender, heightCm, currentWeightKg, birthDate, activityLevel, planType, targetWeightKg } = state.data;
    
    if (!gender || !heightCm || !currentWeightKg || !birthDate || !activityLevel || !planType || !targetWeightKg) {
